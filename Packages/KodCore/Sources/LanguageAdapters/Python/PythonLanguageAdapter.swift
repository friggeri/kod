...
public enum PythonLanguageAdapter: LanguageAdapter {
    ...
    public static let fileExtensions: Set<String> = ["py", "pyi"]
    ...
    public static func discover(
        ...
        try LanguageServerDiscoveryEngine.resolve(
            ...
            managedInstallProbe: {
                ManagedInstallDiscoverySource.discover(serverID: "pyright", controller: ManagedInstallDiscoverySource.shared)
            },
