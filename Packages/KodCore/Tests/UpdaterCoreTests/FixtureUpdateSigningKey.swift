...
/// sign fixture update feeds in `UpdaterCoreTests`. This is not how
/// `UpdateFeedSigner`/`UpdateFeedTrustRoot` are meant to be used in a
/// real release — see `Scripts/release/README.md` for that process,
/// which never generates or stores a real private key in this
...
enum FixtureUpdateSigningKey {
    ...
    /// runs so fixture feeds are reproducible byte-for-byte.
