...
final class PreviewViewController: NSViewController {
    ...
    @MainActor
    static func confirmWithAlert(_ url: URL) -> Bool {
        let alert = NSAlert()
        alert.messageText = Localized.string("Open Link?", comment: "Alert title asking whether to open an external link from an untrusted workspace")
        ...
        alert.addButton(withTitle: Localized.string("Open", comment: "Button title confirming opening the external link"))
        alert.addButton(withTitle: Localized.string("Cancel", comment: "Button title canceling the external link open"))
