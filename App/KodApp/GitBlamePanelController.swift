...
@MainActor
final class GitBlamePanelController: NSWindowController {
    ...
    func show(result: GitBlameResult, asSheetFor parent: NSWindow) {
    ...
    private func presentPopover(for line: GitBlameLine) {
        ...
        label.setAccessibilityLabel(Localized.string("Commit details", comment: "Accessibility label for the Git blame commit-details popover text"))
        ...
        // animation is the one place in `App/KodApp/` where AppKit
